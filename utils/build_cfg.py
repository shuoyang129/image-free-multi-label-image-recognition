...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.Caption.N_CTX = 32  # number of context vectors
    cfg.TRAINER.Caption.CSC = False  # class-specific context
    cfg.TRAINER.Caption.GRAPH_PROMPT = True
    cfg.TRAINER.Caption.GRAPH_PROMPT_DOUBLE = False
    # cfg.TRAINER.Caption.CTX_INIT = "A photo of a"  # initialization words
    ...
    cfg.TRAIN.LOSSFUNC = "double_ranking"
...
def reset_cfg(cfg, args):
    ...
    if args.csc:
        ...
        cfg.TRAINER.Caption.CSC = args.csc
